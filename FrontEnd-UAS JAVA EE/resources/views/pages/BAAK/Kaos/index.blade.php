                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <a href="{{ route('Create_kaos') }}" class="btn btn-primary ms-auto">Tambah kaos</a>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                            ...
                                            <tbody>
                                                @foreach($kaos as $data)
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <a href="{{ route('Edit_kaos', ['id' => $data['id']]) }}" class="btn-edit">
                                                            <i class="fa fa-copy	
                                                            "></i> Edit |
                                                          </a>
                                                          <!-- Tombol hapus dengan ikon -->
                                                          <a href="{{ route('Delete_kaos', ['id' => $data['id']]) }}" class="btn-delete">
