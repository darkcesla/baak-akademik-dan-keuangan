                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    Ruangan
                                    <!-- Tambah tombol "Tambah Ruangan" di samping -->
                                    <a href="{{ route('Create_Ruangan') }}" class="btn btn-primary ms-auto">Tambah Ruangan</a>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                            ...
                                            <tbody>
                                                @foreach($ruangan as $data)
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <a href="{{ route('Edit_Ruangan', ['id' => $data['id']]) }}" class="btn-edit">
                                                            <i class="fa fa-copy	
                                                            "></i> Edit |
                                                          </a>
                                                          <!-- Tombol hapus dengan ikon -->
                                                          <a href="{{ route('Delete_Ruangan', ['id' => $data['id']]) }}" class="btn-delete">
