                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <a href="{{ route('Add_IB') }}" class="btn btn-primary ms-auto">Request IB</a>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            @if($data['status'] == "Canceled" || $data['status'] == "Rejected") 
                                                             ...
                                                             <a href="{{ route('generate', ['id' => $data['id']]) }}" class="btn-edit">
                                                             ...
                                                             <a href="{{ route('Canceled_IB', ['id' => $data['id']]) }}" class="btn-edit">
                                                                <i class="fas fa-ban		
                                                                "></i> Canceled 
                                                                </a>
                                                            @endif
